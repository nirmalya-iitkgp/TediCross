...
["list", "heading"].forEach(type => {
    ...
    simple_markdown_1.default.defaultRules[type] = {
        order: Number.POSITIVE_INFINITY,
        match: () => null // Never match anything in order to ignore this rule
    };
});
// Shorthand for the parser
const mdParse = simple_markdown_1.default.defaultBlockParse;
/*****************************
...
function md2html(text) {
    ...
    text = ramda_1.default.replace("@\u200B", "@", ramda_1.default.defaultTo("", text));
    // Escape HTML in the input
    const processedText = (0, helpers_1.escapeHTMLSpecialChars)(text);
