...
function handleEmbed(embed, senderName) {
    ...
    if (embed.description !== undefined) {
        text += (0, md2html_1.md2html)(embed.description) + "\n";
    }
    // Handle the fields
    embed.fields.forEach(field => {
        text += `\n<b>${field.name}</b>\n` + (0, md2html_1.md2html)(field.value) + "\n";
    });
...
exports.handleEmbed = handleEmbed;
//# sourceMappingURL=handleEmbed.js.map