...
const BridgeSettingsTelegram_1 = require("./BridgeSettingsTelegram");
const BridgeSettingsDiscord_1 = require("./BridgeSettingsDiscord");
/********************
 * The Bridge class *
 ********************/
...
class Bridge {
    ...
    constructor(settings) {
        ...
        this.telegram = new BridgeSettingsTelegram_1.BridgeSettingsTelegram(settings.telegram);
        /** Settings for the Discord side of the bridge */
        this.discord = new BridgeSettingsDiscord_1.BridgeSettingsDiscord(settings.discord);
    }
    /**
    ...
    static validate(settings) {
        ...
        BridgeSettingsTelegram_1.BridgeSettingsTelegram.validate(settings.telegram);
        // Check the Discord settings
        BridgeSettingsDiscord_1.BridgeSettingsDiscord.validate(settings.discord);
    }
